...
# Import routers
from backend.app.routers import matches, players, rankings, chemistry, power_index, team_generator, pages
...
app.include_router(power_index.router, prefix="/api/v1/power-index", tags=["power_index"])
app.include_router(team_generator.router, prefix="/api/v1/teams", tags=["team_generator"])
